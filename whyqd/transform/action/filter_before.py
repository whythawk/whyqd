...
if TYPE_CHECKING:
    ...
    from whyqd.metamodel.models import FieldModel, ColumnModel


class Action(BaseFilterAction):
    """Filter a table by a date column prior to a specified date.
    ...
    def __init__(self) -> None:
        ...
        self.description = "Filter a table by a date column prior to a specified date."
        self.structure = ["date"]
    ...
    def transform(
        ...
        *,
        ...
        from whyqd.transform.parsers import WranglingScript
