...
if TYPE_CHECKING:
    from whyqd.metamodel.models import CategoryActionModel
...
class BaseCategoryAction:
    ...
    * `unique`: the specific columns effected by the morph, a `list` of `ColumnModel` or, rarely, `FieldModel`.
    ...
    def parse(self, *, script: str) -> Dict[str, str]:
        ...
        source_terms = parser.get_split_terms(script=root[1], by="::")
        ...
        destination_terms = parser.get_split_terms(script=root[1], by="::")
